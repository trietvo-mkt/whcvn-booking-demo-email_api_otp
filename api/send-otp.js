export default async function handler(req, res) {
  ...
  const emailHtml = `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #ffffff;">
      <div style="background: #00adee; padding: 24px; text-align: center;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center">
          <svg xmlns="http://www.w3.org/2000/svg" width="160" height="36" viewBox="0 0 3420 1028" style="display:block;margin:0 auto;">
            ...
            <g fill="#ffffff">
              ...
              <path d="M2808.89,663.61c-18.51-15.86-27.84-37.7-27.84-65.54v-76.7c0-27.84,9.32-49.68,27.84-65.54,18.58-15.93,44.24-23.89,77.04-23.89s59.28,7.96,77.72,23.89c18.38,15.86,27.56,37.7,27.56,65.54v76.7c0,27.84-9.19,49.68-27.56,65.54-18.44,15.93-44.37,23.89-77.72,23.89s-58.46-7.96-77.04-23.89Z"/>
              <path d="M3069.89,679.06c-14.97-5.58-25.45-13.82-31.37-24.57-5.92-10.75-8.85-24.57-8.85-41.38,0-18.44,3.47-32.87,10.48-43.35,7.01-10.41,18.1-17.97,33.28-22.66,15.11-4.7,35.32-7.01,60.57-7.01,11.57,0,26.2.75,44.03,2.31l9.8.95v-18.24c0-18.1-4.15-31.99-12.39-41.72-8.3-9.66-22.73-14.5-43.29-14.5-27.77,0-47.3,9.66-58.53,29.06-1.23,2.18-2.59,3.88-3.95,5.1-1.43,1.29-2.93,1.91-4.49,1.91-.61,0-2.79-.61-6.53-1.91l-14.97-6.06c-5.31-2.52-7.96-5.44-7.96-8.92,0-2.18.61-4.49,1.84-7.01,17.49-32.74,49.34-49.14,95.55-49.14,35.25,0,60.1,8.44,74.66,25.25,14.5,16.88,21.71,39.95,21.71,69.28v122.16c0,8.17-1.16,13.88-3.47,17.35-2.38,3.4-6.81,6.53-13.34,9.32-18.72,8.17-45.6,12.18-80.51,12.18-26.54,0-47.3-2.79-62.27-8.44Z"/>
      ...
      <div style="text-align: center; padding: 32px 24px 16px;">
        <h2 style="color: #1E293B; margin: 0 0 8px; font-size: 20px;">Mã xác thực OTP của bạn</h2>
        <p style="color: #64748B; margin: 0 0 24px; font-size: 14px;">Vui lòng nhập mã bên dưới để xác thực email</p>
        <div style="background: #F8FAFC; border: 2px solid #00adee; border-radius: 12px; padding: 20px; display: inline-block;">
          <span style="font-size: 36px; font-weight: 800; letter-spacing: 12px; color: #00adee;">${otp}</span>
        </div>
        <p style="color: #64748B; margin: 20px 0 0; font-size: 13px;">Mã có hiệu lực trong 5 phút. Không chia sẻ mã này với bất kỳ ai.</p>
      </div>
  ...
  try {
    const response = await fetch('https://api.brevo.com/v3/smtp/email', {
      ...
      body: JSON.stringify({
        ...
        to: [{ email: to }],
        subject: `Mã xác thực OTP - WhiteCoat`,
    ...
    // Return OTP to frontend for verification (in production, store server-side)
